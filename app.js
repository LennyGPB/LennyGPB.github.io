...
// .pauseFor(1800)
// .changeDelay(20)
// .typeString('Moi c\'est Lenny Gomes')
// .pauseFor(300)
.typeString('<strong> Développeur Full-Stack</strong> !')
.pauseFor(1000)
.deleteChars(13)
.typeString('<span style="color: #7806d4;"> C# Multi-Plateformes</span> !')
.pauseFor(1500)
.deleteChars(22)
.typeString('<span style="color: #7806d4;"> PHP - SYMFONY</span> !')
.pauseFor(1500)
.deleteChars(15)
.typeString('<span style="color: #7806d4;"> JavaScript</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #7806d4;"> WEB</span> !')
.start()
